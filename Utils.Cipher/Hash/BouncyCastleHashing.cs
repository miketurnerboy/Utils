...
namespace Utils.Cipher
{
    ...
    public static class BouncyCastleHashing
    {
        ...
        public static string PBKDF2_SHA256_GetHash(SecureString password, int iterations, int hashByteSize, string saltAsBase64String)
        {
            byte[] saltBytes = Convert.FromBase64String(saltAsBase64String);

            byte[] hash = PBKDF2_SHA256_GetHash(password, saltBytes, iterations, hashByteSize);
        ...
        public static byte[] PBKDF2_SHA256_GetHash(SecureString password, byte[] salt, int iterations, int hashByteSize)
        {
        ...
        public static bool ValidatePassword(SecureString password, string saltAsBase64String, int iterations, int hashByteSize, string hashAsBase64String )
        {
            byte[] saltBytes = Convert.FromBase64String(saltAsBase64String);
        ...
        public static bool ValidatePassword(SecureString password, byte[] saltBytes, int iterations, int hashByteSize, byte[] actualGainedHasAsByteArray)
        {
